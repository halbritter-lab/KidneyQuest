...
must_haves:
  truths:
    - "Missing sprites degrade gracefully without crashing"
    - "Particle bursts render and fade correctly"
    - "Player death animation freezes all other state transitions"
