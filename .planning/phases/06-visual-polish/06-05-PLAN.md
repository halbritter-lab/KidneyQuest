...
4. "Collect the Genes!" tagline visible
...
**Game Over (trigger via console: window.triggerGameOver()):**
14. Screen shakes briefly on death
15. Red particles burst from player position
...
18. Score breakdown shows distance in meters
19. "Press Space to Retry" pulses after cooldown
20. Press Space to restart -- all visuals reset cleanly

**Performance:**
21. Open DevTools Performance tab, record 10 seconds of gameplay
22. Frame rate should stay above 55fps

**No regressions:**
23. Jump physics unchanged (Space to jump, double jump works)
24. Pause works (Escape key)
...
- VIZP-05: Gene glow effect with pulsing shadowBlur
- VIZP-06: 5-layer parallax background with different scroll speeds
- VIZP-07: KidneyQuest title + tagline on start screen (CeRKiD branding override honored)
- VIZP-08: Game over score breakdown (distance + genes)
</verification>

<success_criteria>
All 25 verification steps pass. Game looks like a themed kidney runner instead of a prototype. Performance is acceptable. No regressions in gameplay mechanics.
</success_criteria>
